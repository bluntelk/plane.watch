...
func decodeAC12Field(AC12Field int32) int32 {
	var q_bit bool = (AC12Field & 0x10) == 0x10
	var n int32
...
func decodeID13Field(ID13Field int32) int32 {
	...
	if 0 < (ID13Field & 0x1000) {
		hexGillham |= 0x0010; } // Bit 12 = C1
	if 0 < (ID13Field & 0x0800) {
		hexGillham |= 0x1000; } // Bit 11 = A1
	if 0 < (ID13Field & 0x0400) {
		hexGillham |= 0x0020; } // Bit 10 = C2
	if 0 < (ID13Field & 0x0200) {
		hexGillham |= 0x2000; } // Bit  9 = A2
	if 0 < (ID13Field & 0x0100) {
		hexGillham |= 0x0040; } // Bit  8 = C4
	if 0 < (ID13Field & 0x0080) {
		hexGillham |= 0x4000; } // Bit  7 = A4
	//if (ID13Field & 0x0040) {hexGillham |= 0x0800;} // Bit  6 = X  or M
	if 0 < (ID13Field & 0x0020) {
		hexGillham |= 0x0100; } // Bit  5 = B1
	if 0 < (ID13Field & 0x0010) {
		hexGillham |= 0x0001; } // Bit  4 = D1 or Q
	if 0 < (ID13Field & 0x0008) {
		hexGillham |= 0x0200; } // Bit  3 = B2
	if 0 < (ID13Field & 0x0004) {
		hexGillham |= 0x0002; } // Bit  2 = D2
	if 0 < (ID13Field & 0x0002) {
		hexGillham |= 0x0400; } // Bit  1 = B4
	if 0 < (ID13Field & 0x0001) {
		hexGillham |= 0x0004; } // Bit  0 = D4
