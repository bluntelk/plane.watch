...
// BrowseResultItem struct for BrowseResultItem
...
func (o BrowseResultItem) MarshalJSON() ([]byte, error) {
...
type NullableBrowseResultItem struct {
	value *BrowseResultItem
	isSet bool
}

func (v NullableBrowseResultItem) Get() *BrowseResultItem {
	return v.value
}

func (v *NullableBrowseResultItem) Set(val *BrowseResultItem) {
	v.value = val
	v.isSet = true
}

func (v NullableBrowseResultItem) IsSet() bool {
	return v.isSet
}

func (v *NullableBrowseResultItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBrowseResultItem(val *BrowseResultItem) *NullableBrowseResultItem {
	return &NullableBrowseResultItem{value: val, isSet: true}
}

func (v NullableBrowseResultItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBrowseResultItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
